...
class RcsProvisioningManager(
    ...
    private fun performLegacyRegistration(phoneNumber: String?, rcsConfiguration: RcsConfiguration): Boolean {
        ...
        // We cannot assume success without configuration. 
        // If we don't have an AutoConfig URL and we don't have hardcoded SIP details, we fail.
        Log.e(TAG, "Legacy/Direct provisioning failed: No valid configuration available.")
        return false
    }
